...
def read_and_sort_file(file_path):
    ...
    new_file_path = file_path.replace('arq.txt', 'arq-teste-ordenado-quickSort-python.txt')
...
result_file_path = os.path.join(resultados_folder, 'resultado-quick-python.txt')
